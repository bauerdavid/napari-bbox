# An copy of napari.layers.shapes._mesh
...
class Mesh:
    """Contains meshses of bounding boxes that will ultimately get rendered.
    ...
    vertices : np.ndarray
         ...
         faces For each bounding box, we store the vertices of the triangles first, then vertices of edges
    ...
    def clear(self) -> None:
        ...
        self.displayed_triangles_to_bounding_box_index = np.zeros(1, dtype=IndexDtype)
